...
def main():
    ...
    for name in image_names:
        ...
        img0 = transforms.normalize_img(img0.astype(float), normalize=True, norm3D=True, invert=False, lowhigh=None, percentile=(1.0, 99.0))    
        ...
        for p in range(3):
            ...
            for k, img in enumerate(imgs):
                if args.tile_norm:
                    img = transforms.normalize99_tile(img.astype(float), blocksize=args.tile_norm)
